...
This document outlines a step-by-step plan for rewriting saltybox in Rust while maintaining **exact** on-disk format compatibility and behavioral correctness.
