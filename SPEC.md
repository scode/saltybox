...
file (owner-only permissions, name prefixed `.saltybox-`) behind in the output directory; rename failures report its
path. On Unix the final output file mode is 0600.
